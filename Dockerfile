...
RUN --mount=type=secret,id=ACCESS_TOKEN \
    ...
    # CLEAR
    git clone --single-branch -b master https://WikiteqMachine:$(cat /run/secrets/ACCESS_TOKEN)@github.com/WikiTeq/mediawiki-extension-CLEAR.git $MW_HOME/extensions/CLEAR \
    && cd $MW_HOME/extensions/CLEAR \
    && git checkout -q 4882d6f28de257d2d36fa484997552aa2c1e8a84
