...
RUN set -x; \
	...
	&& git checkout -q f193befe9d66249e694fcdaa7b1b2afbf4a2ffde
# P
RUN set -x; \
	cd $MW_HOME/extensions \
	# PageExchange
...
RUN set -x; \
	...
	&& git fetch https://gerrit.wikimedia.org/r/mediawiki/extensions/GoogleLogin refs/changes/30/1074530/4  \
	&& git checkout FETCH_HEAD
