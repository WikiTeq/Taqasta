...
RUN set -x; \
	...
	&& git checkout -q e68623545dcb1c6e7b8d1e612efa9e472fb9e6ac \
	# CharInsert
...
RUN --mount=type=secret,id=ACCESS_TOKEN \
    ...
    && git checkout -q 8e0c1139b8c90f3f441dd48e8082e3baf1331cd4
...
RUN set -x; \
	...
	&& git checkout -q 5c87fa7061875060c3b06447536262ca0a0ea9ca \
	# Popups
...
RUN set -x; \
	...
	&& git checkout -q f453f2b11f87c28c7d4db91eeaab54c2e14a1702
