...
- 1.3.0 - February 09, 2023 - Update MediaWiki version to 1.39.1, remove FixedHeaderTable, LocalisationUpdate, Mendeley, NumerAlpha, SemanticBreadcrumbLinks, SemanticExternalQueryLookup, SRFEventCalendarMod, Sync and Wiretap extensions, add MediaUploader, Mpdf, ShowMe, TemplateWizard, UserPageViewTracker extensions
