...
- 1.3.0 - January 17, 2023 - Update MediaWiki version to 1.39.1, remove LocalisationUpdate, SemanticExternalQueryLookup, Mendeley, SRFEventCalendarMod, Sync and Wiretap extensions, add MediaUploader, Mpdf, ShowMe, TemplateWizard, UserPageViewTracker extensions
