...
- 1.3.0 - February 16, 2023 - Update MediaWiki version to 1.39.1, remove Favorites, FixedHeaderTable, LocalisationUpdate, Mendeley, NumerAlpha, SemanticBreadcrumbLinks, SemanticExternalQueryLookup, SRFEventCalendarMod, Sync, TimedMediaHandler, Wiretap and googleAnalytics extensions, add DeleteBatch, MediaUploader, Mermaid, Mpdf, SemanticDependencyUpdater, ShowMe, TemplateWizard, TitleIcon, UserPageViewTracker, WatchAnalytics, WhosOnline extensions
