...
- 1.3.0 - January 11, 2023 - Update MediaWiki version to 1.39.1, remove LocalisationUpdate and SemanticExternalQueryLookup extensions, add MediaUploader, Mpdf, ShowMe, TemplateWizard, UserPageViewTracker extensions
